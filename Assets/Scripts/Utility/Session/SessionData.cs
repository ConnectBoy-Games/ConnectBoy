...
public class SessionDetails { public Guid SessionId { get; set; } public GameName GameName { get; set; } public Player HostPlayer { get; set; } public Player OtherPlayer { get; set; } public int Wager { get; set; } }
